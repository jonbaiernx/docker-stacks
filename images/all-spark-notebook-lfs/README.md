# Jupyter Notebook Python, R, Spark Stack with Git LFS support
## Copied from all-spark-notebook image and modified to include Git LFS install

Following is from all-spark-notebook README.md:
